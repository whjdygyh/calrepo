...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/generate-chinese-religious.ps1
python scripts/generate-un-fixed-observances.py
python scripts/generate-catholic-general-roman.py
```
